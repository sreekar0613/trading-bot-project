...
SIGNALS_PATH = REPO_ROOT / "backtest" / "signals_log_relaxed.csv"
...
def run_backtest():
    ...
    # Save reports
    results_path = REPORTS_DIR / "backtest_results_relaxed.csv"
    curve_path = REPORTS_DIR / "equity_curve_relaxed.csv"
